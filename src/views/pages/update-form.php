<div id="rootContent" class="container pt-5">
    <div class="row ml-4 mr-4">
        <form method="post" class="text-left mx-auto" id="userUpdateForm">
            ...
            <div class="form-group">
                ...
                <input name="surname" type="text" class="form-control" id="lastName" aria-describedby="lasNameHelp"
                       placeholder="Enter Last Name" value="<?= $user->surname; ?>" required="">
...
<script type="text/javascript">
    jQuery(function () {
        jQuery('#userUpdateForm').on('submit', (event) => {
            let data = {};
